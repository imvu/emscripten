...
void emscripten_trace_record_allocation(void *address, int32_t size);

void emscripten_trace_record_reallocation(void *old_address, void *new_address, int32_t size);

void emscripten_trace_record_free(void *address);

void emscripten_trace_annotate_address_type(void *address, const char *type);
