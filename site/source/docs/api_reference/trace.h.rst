...
.. code-block:: c
  ...
  emscripten_trace_configure("http://127.0.0.1:5000/api/v1/upload", "MyApplication");
...
.. c:function:: void emscripten_trace_configure(const char *collector_url, const char *application)
   ...
   :param collector_url: The URL of the data upload endpoint for the collector server.
...
.. c:function:: void emscripten_trace_record_allocation(void *address, int32_t size)
...
.. c:function:: void emscripten_trace_record_reallocation(void *old_address, void *new_address, int32_t size)
...
.. c:function:: void emscripten_trace_record_free(void *address)
...
.. c:function:: void emscripten_trace_annotate_address_type(void *address, const char *type)
